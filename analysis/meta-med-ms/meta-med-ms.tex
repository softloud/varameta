...
or the R package \package{metafor}~\cite{viechtbauerConductingMetaanalyses},
...
% \begin{table}[!htbp]
% \resizebox{0.8\textwidth}{!}{\begin{minipage}{0.8\textwidth}
%     \centering
%     \small
