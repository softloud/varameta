...
$\frac{b - a}{2\Phi^{-1}\left(\frac{n - 0.375}n + 0.25{}\right)}$
                  &$C_1 = \{a, m, b; n\}$     \\
Wan \cite{Wan2014}       &   $ \frac{a + 2q_1 + 2m + 2q_3 + b}{8}$
            &
...
This manuscript derives mathematical estimators and presents simulation results of programmed instantiations of the algorithmic solution to the meta-analysis of medians. However, interests in reproducibility
