...
study | input statistics | centre | spread
- | -| - | -
Prendergast |\(C_3 := \{q_1, m, q_3; n\}\) and \(C_1 := \{a, m, b; n\}\) | `NA` | `effect_se`
Hozo | \(C_1 := \{a, m, b; n\}\) | `hozo_mean` | `hozo_se` 
Bland | \(C_2 := \{a, q_1, m, q_3, b; n\}\)| `bland_mean` | `bland_se`
Wan | \(C_1 := \{a, m, b; n\}\)| `wan_mean_C1` | `wan_se_C1`
Wan | \(C_2 := \{a, q_1, m, q_3, b; n\}\)|  `wan_mean_C2` | `wan_se_C2` 
Wan | \(C_3 := \{q_1, m, q_3; n\}\)|  `wan_mean_C3` | `wan_se_C3`
...
Wan *et al.* provide estimators for the same summary sample sets as Hozo *et al.* and Wan *et al.*'s methods.   
